    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-200 mb-8">
        ...
        <div class="grid gap-4">
          <div v-for="player in players" :key="player.id" class="flex justify-between items-center p-4 bg-gray-50 rounded-lg border border-gray-100">
...
// Round time in minutes - default to 5
